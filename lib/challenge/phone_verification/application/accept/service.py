...
class PhoneVerificationAcceptor:
    ...
    @staticmethod
    def new(repository: Repository, event_bus: Bus) -> PhoneVerificationAcceptor:
        """
        ...
        service = PhoneVerificationAcceptor(repository, event_bus)
        return service
