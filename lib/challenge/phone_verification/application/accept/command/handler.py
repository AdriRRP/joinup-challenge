...
from lib.challenge.phone_verification.application.accept.command.command import Command as AcceptCommand
...
class Handler(CommandHandler):
    ...
    def __init__(self, verification_acceptor: PhoneVerificationAcceptor):
        """
    ...
    @staticmethod
    def new(verification_acceptor: PhoneVerificationAcceptor) -> Handler:
        """
